...
from kaos.fractal import petrosian_fd, katz_fd, higuchi_fd, detrended_fluctuation


from kaos.tests.utils import RANDOM_TS, NORMAL_TS, PURE_SINE, ARANGE, TEST_DTYPES
