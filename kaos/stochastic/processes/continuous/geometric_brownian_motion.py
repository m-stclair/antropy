...
from kaos.stochastic.processes.base import BaseTimeProcess
from kaos.stochastic.processes.continuous.brownian_motion import BrownianMotion
from kaos.stochastic.utils import generate_times
